...
public interface ZKPFunction {
     ...
     */
    static boolean oneBallotInformationZKP(BigInteger upk, BigInteger[] arr, Ballot[] voter, JSONObject voterAllZKPInformation){
...
//        System.out.println(voteAllZKP);
     ...
     * 由于我们读取到的每一个投票人员的选票都是一样的，所以我准备写一个函数，把json转成的对象穿进去，这样简化代码。
     */
    static boolean oneBallotInformationZKP(BigInteger upk, BigInteger[] arr, Ballot voter){
        /**
         * firstCom非0即1的证明
         */
