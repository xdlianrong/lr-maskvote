...
public interface PKEncrypt {
    static boolean pKEcryptProof(BigInteger firstCom, BigInteger upk,  BigInteger PKEncryptTemp, BigInteger PKEncryptHash, BigInteger PKEncryptS1,
        ...
        BigInteger newHashc = new BigInteger(com.xdlr.xdublockchainlab.maskvote.encrypt.counter.
                HashFunction.getSHA256StrJava(arr[2].toString()+upk.toString()+PKEncryptTemp.toString())).mod(arr[1]);
