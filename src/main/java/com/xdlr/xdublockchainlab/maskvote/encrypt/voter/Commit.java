package com.xdlr.xdublockchainlab.maskvote.encrypt.voter;

import com.alibaba.fastjson.JSON;
import com.xdlr.xdublockchainlab.maskvote.ConnectionToChain.Connection;
import com.xdlr.xdublockchainlab.maskvote.ConnectionToChain.Invoke;
import com.xdlr.xdublockchainlab.maskvote.bean.*;
...
public class Commit {
     ...
     * 此文件主要是对选票的信息进行承诺，加密
     */
    public static BigInteger[] commitBallot(String voterStr, BigInteger value, BigInteger[] arr){
        //读取联合公钥
...
//        System.out.println(i);
    ...
    public static void CommitAll(String electSearchNum, String str, BigInteger value1, BigInteger value2, BigInteger value3,  BigInteger[] arr) throws CertificateException, InvalidKeyException, IOException {
        /**
         * 第一个候选人的投票信息
         */
        Ballot vote1 = new Ballot();
        BigInteger[] voteArray1 = commitBallot(str,value1, arr);
        ...
        BigInteger[] voteArray2 = commitBallot(str, value2, arr);
        ...
        BigInteger[] voteArray3 = commitBallot(str, value3, arr);
...
//        System.out.println(allZKPStr );
    ...
    public static void mapping(String electSearchNum, String str, Ballot vote1, Ballot vote2, Ballot vote3, String allZKPStr) throws CertificateException, InvalidKeyException, IOException {
        /**
         * 产生json字符串
         */
        TreeMap<String, Ballot> map = new TreeMap<>();
        TreeMap<String, TreeMap<String, Ballot>> treeMap = new TreeMap<>();
        map.put("vote1", vote1);
        map.put("vote2", vote2);
        map.put("vote3", vote3);
        treeMap.put(str, map);
...
//        System.out.println(strTemp);
        ...
        Invoke.invoke(Connection.getNetwork(), electSearchNum+str, strTemp);
     ...
     *  1、也就是只需要产生加密一条交易信息
     */
    public static void CommitOneTransaction(String voteSearchNum, String str, BigInteger value, BigInteger[] arr) throws CertificateException, InvalidKeyException, IOException {
        /**
         * 表决的信息
         */
        Ballot vote1 = new Ballot();
        BigInteger[] voteArray1 = commitBallot1(str,value, arr);
        vote1.setFirstCom(voteArray1[0]);
        vote1.setSecondCom(voteArray1[1]);
        vote1.setFirstComTemp1(voteArray1[2]);
        vote1.setFirstComTemp2(voteArray1[3]);
    ...
    public static BigInteger[] commitBallot1(String voterStr, BigInteger value, BigInteger[] arr){
        //读取联合公钥
        BigInteger upk = ReadUnionPublicKey.getUnionPublicKey();
    ...
    public static void mapping1(String voteSearchNum, String str, Ballot vote1) throws CertificateException, InvalidKeyException, IOException {
        /**
         * 产生json字符串
         */
        TreeMap<String, Ballot> map = new TreeMap<>();
        ...
        //上链
        Invoke.invoke(Connection.getNetwork(), voteSearchNum+str+"Ballot", mapStr);
