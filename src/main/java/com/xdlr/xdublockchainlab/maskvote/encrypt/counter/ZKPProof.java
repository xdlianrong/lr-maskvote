...
//        String[] str = ReadVotier.readBallotInformation("voteInformation.txt");
//        /**
//         * 投票员1的三张选票信息和ZKP
//         */
//        JSONObject voter1Information = JSON.parseObject(str[0]).getJSONObject("voter1");
//        JSONObject voter1Ballot1Information = JSON.parseObject(voter1Information.toString()).getJSONObject("vote1");
//        JSONObject voter1Ballot2Information = JSON.parseObject(voter1Information.toString()).getJSONObject("vote2");
//        JSONObject voter1Ballot3Information = JSON.parseObject(voter1Information.toString()).getJSONObject("vote3");
//        JSONObject voter1AllZKPInformation = JSON.parseObject(voter1Information.toString()).getJSONObject("allZKP");
//        //将投票员1的信息json转换成数组
//        Ballot voter1Ballot1 = JSON.parseObject(String.valueOf(voter1Ballot1Information), Ballot.class);
//        Ballot voter1Ballot2 = JSON.parseObject(String.valueOf(voter1Ballot2Information), Ballot.class);
//        Ballot voter1Ballot3 = JSON.parseObject(String.valueOf(voter1Ballot3Information), Ballot.class);
//////        System.out.println(voter1Ballot1Information);
//////        System.out.println(voter1Ballot2Information);
//////        System.out.println(voter1Ballot3Information);
//////        System.out.println(voter1AllZKPInformation);
//        JSONObject voter2Information = JSON.parseObject(str[1]).getJSONObject("voter2");
//        JSONObject voter2Ballot1Information = JSON.parseObject(voter2Information.toString()).getJSONObject("vote1");
//        JSONObject voter2Ballot2Information = JSON.parseObject(voter2Information.toString()).getJSONObject("vote2");
//        JSONObject voter2Ballot3Information = JSON.parseObject(voter2Information.toString()).getJSONObject("vote3");
//        JSONObject voter2AllZKPInformation = JSON.parseObject(voter2Information.toString()).getJSONObject("allZKP");
//        //将投票员2的信息json转换成数组
//        Ballot voter2Ballot1 = JSON.parseObject(String.valueOf(voter2Ballot1Information), Ballot.class);
//        Ballot voter2Ballot2 = JSON.parseObject(String.valueOf(voter2Ballot2Information), Ballot.class);
//        Ballot voter2Ballot3 = JSON.parseObject(String.valueOf(voter2Ballot3Information), Ballot.class);
//
//        JSONObject voter3Information = JSON.parseObject(str[2]).getJSONObject("voter3");
//        JSONObject voter3Ballot1Information = JSON.parseObject(voter3Information.toString()).getJSONObject("vote1");
//        JSONObject voter3Ballot2Information = JSON.parseObject(voter3Information.toString()).getJSONObject("vote2");
//        JSONObject voter3Ballot3Information = JSON.parseObject(voter3Information.toString()).getJSONObject("vote3");
//        JSONObject voter3AllZKPInformation = JSON.parseObject(voter3Information.toString()).getJSONObject("allZKP");
//        //将投票员1的信息json转换成数组
//        Ballot voter1Ballot1 = JSON.parseObject(String.valueOf(voter3Ballot1Information), Ballot.class);
//        Ballot voter1Ballot2 = JSON.parseObject(String.valueOf(voter3Ballot2Information), Ballot.class);
//        Ballot voter1Ballot3 = JSON.parseObject(String.valueOf(voter3Ballot3Information), Ballot.class);
//        JSONObject voter4Information = JSON.parseObject(str[3]).getJSONObject("voter4");
//        JSONObject voter4Ballot1Information = JSON.parseObject(voter1Information.toString()).getJSONObject("vote1");
//        JSONObject voter4Ballot2Information = JSON.parseObject(voter1Information.toString()).getJSONObject("vote2");
//        JSONObject voter4Ballot3Information = JSON.parseObject(voter1Information.toString()).getJSONObject("vote3");
...
//        Map voter1AllZKP = JSON.parseObject(String.valueOf(voter1Ballot1Information));
//        System.out.println(voter1AllZKP.get("allZKPResponse1"));
//        Ballot voter2 = JSON.parseObject(String.valueOf(voter2Information), Ballot.class);
//        Ballot voter3 = JSON.parseObject(String.valueOf(voter3Information), Ballot.class);
//        Ballot voter4 = JSON.parseObject(String.valueOf(voter4Information), Ballot.class);
...
//            JSONObject voterInformation = JSON.parseObject(str[i]).getJSONObject("voter"+(i+1));
            ...
            JSONObject voterBallot2Information = JSON.parseObject(voterInformation.toString()).getJSONObject("vote2");
            JSONObject voterBallot3Information = JSON.parseObject(voterInformation.toString()).getJSONObject("vote3");
            JSONObject voterAllZKPInformation = JSON.parseObject(voterInformation.toString()).getJSONObject("allZKP");
            //将投票员1的信息json转换成数组
            Ballot voterBallot1 = JSON.parseObject(String.valueOf(voterBallot1Information), Ballot.class);
            Ballot voterBallot2 = JSON.parseObject(String.valueOf(voterBallot2Information), Ballot.class);
            Ballot voterBallot3 = JSON.parseObject(String.valueOf(voterBallot3Information), Ballot.class);
            Ballot[] voter = new Ballot[3];
            voter[0] = voterBallot1;
            voter[1] = voterBallot2;
            voter[2] = voterBallot3;
            boolean result = ZKPFunction.oneBallotInformationZKP(upk, arr, voter, voterAllZKPInformation);
            /**
             * 记得改成result
             */
            if (result){
